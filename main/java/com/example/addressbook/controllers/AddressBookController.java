...
public class AddressBookController {
    ...
    public ResponseEntity<Optional<AddressEntity>> getContactById(@PathVariable Long id) {
        ...
        @PostMapping("/save")
        public AddressEntity addContact(@RequestBody AddressEntityDTO contact) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<AddressEntity> updateContact(@PathVariable Long id, @RequestBody AddressEntityDTO updatedContact) {
